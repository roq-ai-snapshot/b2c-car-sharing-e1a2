  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless mobility with B2C Car Sharing - connecting individual customers to nearby cars, efficiently managed through centralized dashboards."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless mobility with B2C Car Sharing - connecting individual customers to nearby cars, efficiently managed through centralized dashboards.`}
            </Text>
            <Box
